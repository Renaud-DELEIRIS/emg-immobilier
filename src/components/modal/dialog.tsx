...
const effectClassname = {
  ...
  scale:
    "data-[state=closed]:zoom-out-95 data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=open]:zoom-in-[0.1] data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] data-[state=closed]:duration-200 data-[state=open]:duration-200",
};

type Effect = keyof typeof effectClassname;
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "fixed left-[50%] top-[50%] z-50 grid w-full max-w-[95%] translate-x-[-50%] translate-y-[-50%] rounded-xl border border-slate-200 bg-white px-3 py-[18px] shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out dark:border-slate-800  dark:bg-slate-950 sm:rounded-lg md:max-w-lg md:px-6",
