      ...
      <Combobox value={value} onChange={onChange}>
        <div className="relative">
          <div className="relative w-full cursor-default overflow-hidden bg-white text-left ">
            <Combobox.Input
              className="w-full rounded-xl border-2 border-[#EAEBEC] bg-[#EAEBEC] px-5  py-2.5 text-dark focus:border-primary-500 focus:shadow-lg focus:outline-none"
          ...
          <Transition
            ...
            afterLeave={() => setQuery("")}
          >
            <Combobox.Options className="absolute z-20 mt-1 max-h-60 w-full overflow-auto rounded-md border-2 border-primary bg-[#EAEBEC] py-1 text-base text-dark shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
